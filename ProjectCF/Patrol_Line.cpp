...
void PL_PIDCorrection (int opt)
{
	...
	if (opt == 1) {
		...
		if (issix)Motor_GoSpeed(SPEED * 1.4, SPEED2 * 0.6);
		else  if (isone)Motor_GoSpeed(SPEED * 0.6, SPEED2 * 1.4);
		 else if (istwo)Motor_GoSpeed(SPEED * 0.7, SPEED2 * 1.3);
		 else if (isfive)Motor_GoSpeed(SPEED * 1.3, SPEED2 * 0.7);
